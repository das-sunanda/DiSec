...
# Split the original train set into train and validation (90% train, 10% validation)
...
# Load model configuration for 4 classes
print("Initializing model...")
config = RobertaConfig.from_pretrained(config_path, num_labels=4)
model = RobertaForSequenceClassification(config)

# Load state dict
print("Loading model weights...")
# 1. Fix the state dict loading issue
print("Loading model weights...")
